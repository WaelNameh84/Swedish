...
import { aiTeacherTools } from "@/components/AppSidebar";

export default function AiTeacherHubPage() {
  return (
    <div className="min-h-[100dvh] w-full max-w-2xl mx-auto pb-24">
      <header className="sticky top-0 z-30 bg-background/95 backdrop-blur-md border-b border-border px-4 py-4 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-lg font-bold text-foreground leading-tight">الذكاء الاصطناعي</h1>
          <p className="text-xs text-muted-foreground mt-0.5">9 أدوات ذكية لمساعدتك على تعلّم السويدية</p>
        </div>
      </header>
